...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch("https://posts-graphql-backend.herokuapp.com/graphql", {
      headers: {
  ...
  finishEditHandler = (postData) => {
    ...
    fetch("https://posts-graphql-backend.herokuapp.com/post-image", {
      method: "PUT",
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
      ...
      .then((fileResData) => {
        ...
        return fetch("https://posts-graphql-backend.herokuapp.com/graphql", {
          method: "POST",
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: "Bearer " + this.props.token,
